...
print('''
   ...
   YYY    YYY   NNNN       NN   TTTTTTTTTTTT   EEEEEEEEE   MMMM       MMMM
     YY  YY     NN NN      NN        TT        EE          MM MM     MM MM
      YYYY      NN  NN     NN        TT        EE          MM  MM   MM  MM
       YY       NN   NN    NN        TT        EEEEEEEE    MM   MM MM   MM
       YY       NN    NN   NN        TT        EE          MM    MMM    MM
       YY       NN     NN  NN        TT        EE          MM           MM
       YY       NN      NN NN        TT        EE          MM           MM
       YY       NN       NNNN        TT        EEEEEEEEE   MM           MM
 

					       YENİCERİ TİM TERÖRLE MÜCADELE 
	''') # la grafica ci sta
